...
@title{EECS 662: Programming Languages}

@bold{Spring, 2024}

@bold{Lectures:} Tuesday and Thursday, 9:30 - 10:45am, LEEP2 G415
...
Office Hours: Tuesday, 11:00 - 12:00pm @(linebreak)
Office: 2034 Eaton Hall @(linebreak)
@prof-email

@emph{Please email to set an appointment if standard office hours times do not work for you.}

@bold{Teaching Assistant:} @ta @(linebreak)
Office Hours: Tuesday and Wedneday, 2:00 - 3:00pm @(linebreak)
Office: 3025 Eaton Hall @(linebreak)
@ta-email
